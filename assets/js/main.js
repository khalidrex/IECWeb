(function($) {
    ...
    function startProgressBar(swiper) {
        ...
        // Animate from 0% to 100% over the slide display time
    ...
    function resetProgressBar(swiper) {
        ...
        // Reset to 0% when slide transition starts
        progressBar.style.transition = 'none';
        progressBar.style.width = '0%';
    }
    ...
    $(".swiper-group-1").each(function () {
        var swiper = new Swiper(this, {
            ...
            on: {
                init: function() {
                    // Start the bar when the first slide is loaded
                    startProgressBar(this);
                },
                slideChangeTransitionStart: function() {
                    // Reset the bar as soon as the slide starts changing
                    resetProgressBar(this);
                },
                slideChangeTransitionEnd: function() {
                    // Once the new slide is fully visible, start the bar again
                    startProgressBar(this);
                }
            }
        });
